...
setup(
    ...
    packages=['got', 'got.cli', 'got.cli.commands', 'got.cli.got_io', 'got.events', 'got.exceptions', 'got.macros', 'got.service', 'got.tree', 'got.utils'],
    package_dir={"": "."},
    package_data={},
    install_requires=['cleo==0.*,>=0.8.1', 'shellingham==1.*,>=1.3.2', 'treelib==1.*,>=1.6.1', 'watchdog==0.*,>=0.10.2'],
